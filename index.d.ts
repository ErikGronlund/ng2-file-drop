export { FileDropModule as Ng2FileDropModule } from './module/file-drop.module';
export { FileDropDirective as Ng2FileDropDirective } from './directives/file-drop.directive';
